...
{
    public static void lookAtTarget(Entity_AA turret, boolean secondRail) // Server
									  // side
    {
	lookAtTarget(turret, turret.currentTarget, secondRail);
    }

    public static void lookAtTarget(Entity_AA turret, Entity target, boolean secondRail) // Server
											 // side
    {
	if (target == null)
	{
	...
	{
	    AI_Targeting.targetNearestEntity(turret); // Speed the retargeting
						      // up
	    return false;
	}
    ...
    public static void setAttackRange(Entity_AA turret) // Guaranteed to have a
							// weapon
    {
