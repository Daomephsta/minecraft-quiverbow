...
public class Render_AA extends RenderLiving<Entity_AA>
{
    private static ResourceLocation texture = new ResourceLocation(Constants.MODID,
	    "textures/entity/ArmsAssistant.png");

    public Render_AA(RenderManager renderManager)
    {
	super(renderManager, new Model_AA(), 1.0F);
    }

    @Override
    protected ResourceLocation getEntityTexture(Entity_AA entity)
    {
	return texture;
    }

    @Override
    protected void renderLivingAt(Entity_AA entity, double x, double y, double z)
    {
	renderEquippedItems(entity);
	renderStoredItems(entity);
    }

    protected void renderEquippedItems(Entity_AA entity)
    {
