...
public class Entity_AA extends EntityLiving
{
    ...
    public _WeaponBase secondWeapon; // The offhand weapon, if the upgrade is
				     // there
	...
	if (this.wasRiddenLastTick && !this.riddenThisTick) // Not ridden
							    // anymore
	{
	    if (AI_Targeting.isNameOnWhitelist(this, Commands.cmdStayStationary)) // We've
										  // been
										  // ridden
										  // to
										  // another
	...
	if (this.sendStateDelay <= 0)
	{
	    ...
	    AI_Properties.sendStateToPlayersInRange(this); // Update all nearby
							   // players
	}
	...
	if (this.sendInventoryDelay <= 0)
	{
	    ...
	    AI_Properties.sendInventoryToPlayersInRange(this); // Update all
							       // nearby players
	}
    }
	...
	if (AI_Targeting.isNameOnWhitelist(this, Commands.cmdFireRemote)) // Told
									  // to
									  // fire
									  // together
									  // with
									  ...
									  // that
	{
	    ...
	    if (owner != null)
	    {
		ItemStack targeter = InventoryHelper.findItemInHandsByClass(owner, AA_Targeter.class);
		if (!targeter.isEmpty())
		{
		    AA_Targeter weapon = (AA_Targeter) targeter.getItem();
		    RayTraceResult movPos = AI_Targeting.getRayTraceResultFromPlayer(this.world, owner,
							       ...
							       // ready
	{
	    ...
	    {
		AI_WeaponHandler.attackTarget(this, false, ignoreValidation);
	    }
	}
								 ...
								 // is ready
	{
	    ...
	    {
		AI_WeaponHandler.attackTarget(this, true, ignoreValidation);
	    }
	}
    }
	...
	else if (itemstack.getItem() instanceof _WeaponBase)
	{
	    ...
	    {
		AI_WeaponHandler.setSecondWeapon(this, itemstack.copy()); // Equipping
									  // it
									  // in
									  // the
									  // second
		 ...
		 // Works for me
	    {
		AI_WeaponHandler.setFirstWeapon(this, itemstack.copy()); // Equipping
									 // it
	    }
	...
	{
	    AI_Storage.addItem(player, this, itemstack, hand);
	    return true;
	}
	...
	if (!this.world.isRemote) // Spill it all (server-side)
	{
	    ...
	    {
		AI_Communication.tellOwnerAboutDeath(this); // Whelp, you should
							    // probably know
							    // about this
	    }
	}
	...
	{
	    AI_Properties.applyStorageUpgrade(this);
