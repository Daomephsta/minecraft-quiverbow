...
{
	public Crossbow_Auto() { super("auto_crossbow", 8); }
	...
	public void addProps(FMLPreInitializationEvent event, Configuration config)
	{
		...
		this.isMobUsable = config.get(this.name, "Can I be used by QuiverMobs? (default false. They don't know how to rechamber me.)", false).getBoolean(true);
	}
