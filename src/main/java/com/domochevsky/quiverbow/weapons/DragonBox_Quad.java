...
public class DragonBox_Quad extends _WeaponBase
{
     ...
     * this.Icon =
     * par1IconRegister.registerIcon("quiverchevsky:weapons/QuadBox");
     * this.Icon_Empty =
     * par1IconRegister.registerIcon("quiverchevsky:weapons/QuadBox_Empty"); }
     */
	...
	if (this.Enabled)
	{
	    ...
	    // barrels)
	    GameRegistry.addRecipe(new ItemStack(this, 1, this.getMaxDamage()), "ddd", "pdp", "sts", 'p', Blocks.PISTON,
