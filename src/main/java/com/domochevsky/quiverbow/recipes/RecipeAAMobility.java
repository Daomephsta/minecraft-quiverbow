...
public class RecipeAAMobility extends ShapedRecipes implements IRecipe
{
	private ItemStack result;

	public RecipeAAMobility(int sizeX, int sizeY, ItemStack[] components, ItemStack result)
	{
